...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-ca93f646.js",
      css: [assets + "/_app/assets/start-d5b4de3e.css"],
      js: [assets + "/_app/start-ca93f646.js", assets + "/_app/chunks/vendor-d2c730e4.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-68c34384.js", "css": ["assets/pages/__layout.svelte-041920f4.css"], "js": ["pages/__layout.svelte-68c34384.js", "chunks/vendor-d2c730e4.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-de0b4ef8.js", "css": [], "js": ["error.svelte-de0b4ef8.js", "chunks/vendor-d2c730e4.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-1e277a20.js", "css": ["assets/pages/index.svelte-08043d26.css"], "js": ["pages/index.svelte-1e277a20.js", "chunks/vendor-d2c730e4.js"], "styles": [] }, "src/routes/[slug].svelte": { "entry": "pages/[slug].svelte-f332452d.js", "css": [], "js": ["pages/[slug].svelte-f332452d.js", "chunks/vendor-d2c730e4.js"], "styles": [] } };
...
function get$1() {
  let data = import_fs.default.readdirSync(`src/propriedades`).map((fileName) => {
    const f = import_fs.default.readFileSync(`src/propriedades/${fileName}`, { encoding: "utf8", flag: "r" });
    return f;
  });
...
var css$1 = {
  ...
  map: '{"version":3,"file":"__layout.svelte","sources":["__layout.svelte"],"sourcesContent":["<header>\\n</header>\\n\\n<slot />\\n\\n\\n<style type=\\"text/css\\">\\n  @tailwind base;\\n  @tailwind components;\\n  @tailwind utilities;\\n</style>"],"names":[],"mappings":"AAOE,UAAU,IAAI,CAAC,AACf,UAAU,UAAU,CAAC,AACrB,UAAU,SAAS,CAAC"}'
};
...
var Hero = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"m-auto max-w-6xl p-12"}"><div class="${"flex flex-col md:flex-row"}"><div class="${"md:w-1/2 max-w-md flex flex-col justify-center"}"><div class="${"md:text-5xl text-2xl uppercase font-black"}">Joaldo Mendon\xE7a. Corretor de Im\xF3veis</div>
         <div class="${"text-xl mt-4"}">Minha miss\xE3o \xE9 trazer facilidade e qualidade em neg\xF3cios para toda regi\xE3o.</div>
         <div class="${"my-5 h-16"}"><div class="${"shadow-md font-medium py-2 px-4 text-yellow-100 cursor-pointer bg-primaria hover:bg-yellow-500 rounded text-lg text-center w-48"}">Conhe\xE7a nossas propriedades</div></div></div>
