...
<div class="absolute navbar mb-2 bg-transparent text-neutral-content justify-between mt-8">
    <div class="flex-none ml-10 relative">
      <img src="/logo.png" id="logo" on:click={() => window.location = "/"} class="cursor-pointer w-40 ml-20" alt="Logo">
